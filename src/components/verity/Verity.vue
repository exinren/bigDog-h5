...
/**
     ...
     * @description 分发验证码使用
     * */
import VerifySlide from './verityComponents/VeritySlide.vue'
import VerifyPoints from './verityComponents/VerifyPoints.vue'
...
export default {
  ...
  data() {
    return {
      ...
      // 默认图片
      defaultImg: import('@/assets/image/default.jpg')
    }
  },
  computed: {
    instance() {
